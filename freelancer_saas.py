...
pdf.cell(200, 10, txt="FREELANCERTAX  |  Tax Engine ", ln=True, align='C')
pdf.set_font("Helvetica", size=16)
pdf.cell(200, 10, txt="OFFICIAL FREELANCER TAX INVOICE", ln=True, align='C')
pdf.cell(200, 10, txt=f"Country: {country_input}", ln=True)
pdf.cell(200, 10, txt=f"Annual Income: ${income_input}", ln=True)
